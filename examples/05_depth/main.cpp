...
This example demonstrate the setup of a depth buffer.

It is an improvement of the "texture" example

See https://vulkan-tutorial.com/Depth_buffering for the relevant section of Vulkan
Tutorial.
*/
...
protected:
    ...
    {
        // The color buffer attachment (represented by one of the images from the swap chain)
    ...
    void createTextureImage()
    {
        ...
        stbi_uc* pixels = stbi_load(
            (EXECUTABLE_DIR / "textures" / "m31.jpg").c_str(),
        ...
        // Transition the texture image to VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL
        transitionImageLayout(
            commandPool,
            textureImage,
            VK_FORMAT_R8G8B8A8_SRGB,
    ...
    void createTextureImageView()
    {
        textureImageView = createImageView(
            textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, 1
        );
    }
