...
This example displays a textured square

It is an improvement of the "square" example.

Note that the framebuffer only consists of a color buffer (coming from the swap chain).

See https://vulkan-tutorial.com/Texture_mapping/Images for the relevant section of Vulkan
Tutorial.
*/
