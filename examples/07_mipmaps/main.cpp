...
This example generate mimaps for the texture of the displayed object.

It is an improvement of the "model" example.

See https://vulkan-tutorial.com/en/Generating_Mipmaps for the relevant section of Vulkan
Tutorial.
*/
