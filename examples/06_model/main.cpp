...
This example loads a model from an OBJ file instead of hard-coding the vertices.

It is an improvement of the "depth" example

See https://vulkan-tutorial.com/Loading_models for the relevant section of Vulkan
Tutorial.
*/
